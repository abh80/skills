...
| [`scala-fp`](./scala-fp) | Functional programming in Scala — Cats typeclasses, Cats Effect 3, ZIO 2, fs2 streams, parallel/concurrent programming, tagless final, Typelevel/ZIO ecosystem. |
